...
export default function FoundItems() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      setError("");
      try {
        const data = await listItems({ type: "found", q: query.trim() || undefined });
      ...
      <div className="browse-header">
        ...
        <div className="browse-actions">
          <div className="browse-search">
            ...
            <input value={query} onChange={(e)=>setQuery(e.target.value)} placeholder="Search found items..." aria-label="Search items" />
          </div>
